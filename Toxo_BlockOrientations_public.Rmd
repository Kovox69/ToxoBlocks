...
combination_table_supplement <- combination_pairs %>%
  ...
  select(block1 = a, direction1 = b, block2 = c, direction2 = d, n, group) %>% 
  arrange(desc(n))
...
write.csv(orf_supplement_table, file = "ORF_supplement_table.csv", row.names = F)
